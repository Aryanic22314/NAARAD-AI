  ...
  return (
    <div className="min-h-screen bg-stone-950 font-sans selection:bg-saffron-600 selection:text-white overflow-x-hidden">
      ...
      <header className="relative pt-32 pb-20 px-4 md:px-0 bg-[url('https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center">
        <div className="absolute inset-0 bg-gradient-to-b from-stone-950/70 via-stone-950/80 to-stone-950"></div>
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1] drop-shadow-2xl">
              Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-saffron-400 to-gold-500">Cultural Legend</span>
            </h1>
            <p className="text-lg md:text-xl text-stone-300 max-w-lg leading-relaxed">
              Collect 20 Unique NFTs in One Trip. NAARAD preloads your entire cultural journey, unlocking cinematic stories, AR moments, and friend tracking even when the signal disappears.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUE_PROPS.map((prop) => (
              <div key={prop.id} className="p-6 bg-stone-950 border border-stone-800 rounded-xl hover:border-saffron-600/40 transition-colors group">
                <div className="text-4xl mb-4 grayscale group-hover:grayscale-0 transition-all">{prop.icon}</div>
                <h3 className="font-serif text-lg text-saffron-500 mb-2 leading-tight">{prop.differentiator}</h3>
                <p className="text-sm text-stone-400 leading-relaxed font-sans">{prop.headline}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 overflow-hidden relative" id="quests">
        <div className="max-w-7xl mx-auto px-4 mb-8 flex justify-between items-end">
          ...
          <div className="hidden md:flex gap-2">
            <button className="w-10 h-10 rounded-full border border-stone-700 flex items-center justify-center text-white hover:bg-stone-800">←</button>
            <button className="w-10 h-10 rounded-full border border-stone-700 flex items-center justify-center text-white hover:bg-stone-800">→</button>
          </div>
        </div>
        ...
        <div className="flex overflow-x-auto gap-6 px-4 pb-12 snap-x snap-mandatory scrollbar-hide max-w-[100vw]">
          <div className="w-[max(0px,calc(50%-42rem))] shrink-0"></div> {/* Spacer for centering */}
      ...
      {/* AI Oracle Section */}
      <section className="py-20 bg-stone-950 relative border-t border-stone-900" id="oracle">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-saffron-900/10 via-stone-950 to-stone-950 pointer-events-none"></div>
      ...
      <footer className="bg-stone-950 py-12 px-4 border-t border-stone-900 text-stone-500 text-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
           ...
           <div className="flex gap-6">
             <a href="#" className="hover:text-saffron-500">Privacy Policy</a>
             <a href="#" className="hover:text-saffron-500">Terms of Service</a>
             <a href="#" className="hover:text-saffron-500">Imprint</a>
           </div>
